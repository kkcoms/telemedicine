...
import com.medical.telemedicine.activities.ChatActivity;
...
import com.medical.telemedicine.utils.FirebaseUploader;
...
public class FirebaseChatService extends Service {
    ...
    public void onCreate() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID_MAIN, getResources().getString(R.string.app_name) + " service", NotificationManager.IMPORTANCE_LOW);
            channel.setSound(null, null);
            ((NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE)).createNotificationChannel(channel);
        }
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID_MAIN)
                .setSmallIcon(R.drawable.pediatrician)
    ...
    private void notifyNewGroup(Group group) {
        ...
        notificationBuilder.setSmallIcon(R.drawable.pediatrician)
