...
import com.medical.telemedicine.models.LogCall;
import com.medical.telemedicine.models.User;
import com.medical.telemedicine.services.SinchService;
import com.medical.telemedicine.utils.AudioPlayer;
...
public class CallScreenActivity extends BaseActivity implements SensorEventListener {
    ...
    private TextView mCallDuration, mCallState, mCallerName, instant_calling;
            ...
            if (distance < 4) {
                ...
                if (pm != null) {
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        if (wlOff == null)
                            wlOff = pm.newWakeLock(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK, "Appname:tag");
                ...
                if (pm != null) {
                    if (wlOn == null)
                        wlOn = pm.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "Appname:tag");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instant_calling = findViewById(R.id.instant_calling);
    ...
    private void updateUI() {
        ...
        if (call != null) {
            ...
            instant_calling.setText(isVideo ? getString(R.string.video_calling) : getString(R.string.voice_calling));
    ...
    private void startAlphaAnimation() {
        ...
        instant_calling.startAnimation(animation1);
